   ...
   function renderHeader() {
      return (
         <View style={{ flexDirection: "column", marginHorizontal: wp(5.6) }}>
            ...
            <Text style={{ ...FONTS.modalText1, marginTop: hp(2.22) }}>БҮРТГҮҮЛЭХ</Text>
         ...
         <View style={styles.modalContainer}>
            ...
            >
               <View style={styles.modalBody}>
                  ...
                  <TouchableOpacity style={styles.btnContainer} onPress={takePhotoFromCamera}>
                     <Text style={styles.btnText}>TAKE PHOTO</Text>
                  </TouchableOpacity>
                  <TouchableOpacity style={styles.btnContainer} onPress={choosePhotoFromLibrary}>
      ...
      return (
         <SafeAreaView>
            <View>
               ...
               <MyInput
                  placeholder="Сургуулийн нэрээ бичнэ үү."
               />
               <Text style={styles.textInputTitle}>Өөрийн цээж зураг эсвэл сурагчийн үнэмлэх</Text>
               ...
               <TouchableOpacity style={styles.btnContainer} onPress={() => setModalVisible(!isModalVisible)}>
